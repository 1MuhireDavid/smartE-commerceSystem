...
@Schema(description = "Payload for self-registration (always creates a customer account)")
public class RegisterRequest {
    ...
    @Schema(description = "Email address", example = "john@example.com", maxLength = 100)
    @NotBlank(message = "Email is required")
    @Email(message = "Invalid email format")
    @Size(max = 100, message = "Email must not exceed 100 characters")
    private String email;

    @Schema(description = "Password (min 8 characters)", example = "Secret123!", minLength = 8)
