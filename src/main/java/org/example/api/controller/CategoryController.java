...
public class CategoryController {
    ...
    @GetMapping
    public ResponseEntity<org.example.api.dto.ApiResponse<PagedResponse<CategoryEntity>>> list(
        ...
        return ResponseEntity.ok(
                org.example.api.dto.ApiResponse.success("Categories retrieved successfully", data));
    }
    ...
    @GetMapping("/{id}")
    public ResponseEntity<org.example.api.dto.ApiResponse<CategoryEntity>> getById(
            @Parameter(description = "Category ID", required = true, example = "1")
            @PathVariable int id) {
        CategoryEntity category = categoryService.findById(id);
        return ResponseEntity.ok(org.example.api.dto.ApiResponse.success(category));
    }
    ...
    @PostMapping
    public ResponseEntity<org.example.api.dto.ApiResponse<CategoryEntity>> create(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(org.example.api.dto.ApiResponse.success("Category created successfully", created));
    }
    ...
    @PutMapping("/{id}")
    public ResponseEntity<org.example.api.dto.ApiResponse<CategoryEntity>> update(
            @Parameter(description = "Category ID", required = true, example = "1")
            @PathVariable int id,
            @Valid @RequestBody CategoryRequest request) {
        CategoryEntity updated = categoryService.update(id, request);
        return ResponseEntity.ok(
                org.example.api.dto.ApiResponse.success("Category updated successfully", updated));
    }
    ...
    public ResponseEntity<org.example.api.dto.ApiResponse<Void>> delete(
        ...
        return ResponseEntity.ok(
                org.example.api.dto.ApiResponse.success("Category deleted successfully", null));
    }
}
