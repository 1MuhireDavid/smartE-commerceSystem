...
INSERT INTO users (username, email, password_hash, full_name, phone, address, role) VALUES
    ('admin',     'admin@smartecom.com',  '$2b$12$admin_hash_placeholder',   'System Admin',    '0780012312', NULL,        'admin'),
    ('techsell',  'techsell@example.com', '$2b$12$seller1_hash_placeholder', 'Tech Sellers Inc','0780012313', NULL,        'seller'),
    ('fashionco', 'fashion@example.com',  '$2b$12$seller2_hash_placeholder', 'Fashion Co',      '0780012314', NULL,        'seller'),
    ('alice',     'alice@example.com',    '$2b$12$alice_hash_placeholder',   'Alice Nguyen',    '0780012315', 'Kigali',    'customer'),
    ('bob',       'bob@example.com',      '$2b$12$bob_hash_placeholder',     'Bob Mensah',      '0780012316', 'Bugesera',  'customer'),
    ('carol',     'carol@example.com',    '$2b$12$carol_hash_placeholder',   'Carol Tetteh',    '0780012317', 'Nyagatare', 'customer'),
    ('dave',      'dave@example.com',     '$2b$12$dave_hash_placeholder',    'David Kwame',     NULL,         'Gasabo',    'customer');
...
INSERT INTO categories (name, slug, is_active, display_order) VALUES
    ...
    ('Audio',       'audio',       TRUE, 3),
    ('Accessories', 'accessories', TRUE, 4);

-- Clothing sub-categories
INSERT INTO categories (name, slug, is_active, display_order) VALUES
    ('Men''s Wear',   'mens-wear',   TRUE, 1),
    ('Women''s Wear', 'womens-wear', TRUE, 2),
    ('Footwear',      'footwear',    TRUE, 3);
...
-- ─── Orders ───────────────────────────────────────────────────────────────────
-- order_id auto-assigned 1-6 by BIGSERIAL
INSERT INTO orders (user_id, order_number, status, subtotal, discount_amount, total_amount, payment_status) VALUES
    (4, 'ORD-2026-000001', 'completed',  1349.98,   0.00, 1349.98, 'paid'),      -- id=1
    (5, 'ORD-2026-000002', 'completed',   169.98,   0.00,  169.98, 'paid'),      -- id=2
    (4, 'ORD-2026-000003', 'processing',   34.99,   0.00,   34.99, 'paid'),      -- id=3
    (7, 'ORD-2026-000004', 'pending',     599.99,  50.00,  549.99, 'unpaid'),    -- id=4
    (5, 'ORD-2026-000005', 'completed',    64.98,   0.00,   64.98, 'paid'),      -- id=5
    (6, 'ORD-2026-000006', 'cancelled',   349.99,   0.00,  349.99, 'refunded'); -- id=6

-- ─── Order Items ──────────────────────────────────────────────────────────────
INSERT INTO order_items (order_id, product_id, quantity, unit_price, item_status) VALUES
    (1, 1,  1,  999.99, 'completed'),   -- Samsung Galaxy S24
    (1, 3,  1,  349.99, 'completed'),   -- Sony WH-1000XM5
    (2, 8,  1,   59.99, 'completed'),   -- Levi's Jeans
    (2, 9,  1,  110.00, 'completed'),   -- Nike Air Force 1
    (3, 14, 1,   34.99, 'pending'),     -- Clean Code (processing)
    (4, 20, 1,  549.99, 'pending'),     -- Dyson Airwrap (pending)
    (5, 16, 1,   19.99, 'completed'),   -- Atomic Habits
    (5, 17, 1,   45.00, 'completed'),   -- Yoga Mat Pro
    (6, 18, 1,  349.99, 'returned');    -- Adjustable Dumbbell Set (cancelled)

-- ─── Payments ─────────────────────────────────────────────────────────────────
-- Only paid/refunded orders have payment records; order 4 (unpaid) has none
INSERT INTO payments (order_id, payment_method, transaction_id, amount, status, paid_at) VALUES
    (1, 'card',         'TXN-20260115001', 1349.98, 'completed', '2026-01-15 10:22:00'),
    (2, 'paypal',       'TXN-20260120002',  169.98, 'completed', '2026-01-20 14:35:00'),
    (3, 'mobile_money', 'TXN-20260202003',   34.99, 'completed', '2026-02-02 09:10:00'),
    (5, 'card',         'TXN-20260218005',   64.98, 'completed', '2026-02-18 11:05:00'),
    (6, 'paypal',       'TXN-20260220006',  349.99, 'refunded',  '2026-02-20 08:30:00');
...
INSERT INTO reviews (product_id, user_id, order_id, rating, title, body, is_approved) VALUES
    ...
    (14, 4, 3,    5, 'Changed how I code',  'Must-read for any software developer.',                  TRUE),
    (16, 6, NULL, 4, 'Great habit book',    'Practical and very insightful.',                         TRUE),
    (19, 6, NULL, 5, 'Love this cream',     'Cleared my dry patches within a week.',                  TRUE);
...
INSERT INTO activity_logs (user_id, event_type, event_data) VALUES
    ...
    (5, 'checkout_start','{"cart_id":2,"items":2,"subtotal":169.98}'),
    ...
    (4, 'order_placed',  '{"order_id":3,"order_number":"ORD-2026-000003","total":34.99,"payment_method":"mobile_money"}');
